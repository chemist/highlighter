module Text.Highlighter.Lexers.Gnuplot (lexer) where
...
lexer = Lexer
    { lName = "Gnuplot"
    , lAliases = ["gnuplot"]
    , lExtensions = [".plot", ".plt"]
    , lMimetypes = ["text/x-gnuplot"]
    , lStart = root'
    , lFlags = [multiline]
    }
...
quit' :: TokenMatcher
quit' =
    [ tok "gnuplot\\b" (Arbitrary "Keyword")
    , anyOf noargs'
    ]

sqstring' :: TokenMatcher
sqstring' =
    [ tok "''" (Arbitrary "Literal" :. Arbitrary "String")
    , tokNext "'" (Arbitrary "Literal" :. Arbitrary "String") Pop
    , tok "[^\\\\'\\n]+" (Arbitrary "Literal" :. Arbitrary "String")
...
whitespace' =
    ...
    , tok "[ \\t\\v\\f]+" (Arbitrary "Text")
    ]

fit' :: TokenMatcher
fit' =
    [ tok "via\\b" (Arbitrary "Name" :. Arbitrary "Builtin")
    , anyOf plot'
    ]
...
genericargs' =
    ...
    , tok "(eq|ne)\\b" (Arbitrary "Operator" :. Arbitrary "Word")
...
save' :: TokenMatcher
save' =
    [ tok "functions\\b|function\\b|functio\\b|functi\\b|funct\\b|func\\b|fun\\b|fu\\b|f\\b|set\\b|se\\b|s\\b|terminal\\b|termina\\b|termin\\b|termi\\b|term\\b|ter\\b|te\\b|t\\b|variables\\b|variable\\b|variabl\\b|variab\\b|varia\\b|vari\\b|var\\b|va\\b|v\\b" (Arbitrary "Name" :. Arbitrary "Builtin")
    , anyOf genericargs'
    ]
...
root' =
    [ anyOf whitespace'
    , tokNext "bind\\b|bin\\b|bi\\b" (Arbitrary "Keyword") (GoTo bind')
    , tokNext "exit\\b|exi\\b|ex\\b|quit\\b|qui\\b|qu\\b|q\\b" (Arbitrary "Keyword") (GoTo quit')
    , tokNext "fit\\b|fi\\b|f\\b" (Arbitrary "Keyword") (GoTo fit')
    , tokNext "(if)(\\s*)(\\()" (ByGroups [(Arbitrary "Keyword"), (Arbitrary "Text"), (Arbitrary "Punctuation")]) (GoTo if')
    , tok "else\\b" (Arbitrary "Keyword")
    , tokNext "pause\\b|paus\\b|pau\\b|pa\\b" (Arbitrary "Keyword") (GoTo pause')
    , tokNext "plot\\b|plo\\b|pl\\b|p\\b|replot\\b|replo\\b|repl\\b|rep\\b|splot\\b|splo\\b|spl\\b|sp\\b" (Arbitrary "Keyword") (GoTo plot')
    , tokNext "save\\b|sav\\b|sa\\b" (Arbitrary "Keyword") (GoTo save')
    , tokNext "set\\b|se\\b" (Arbitrary "Keyword") (DoAll [(GoTo genericargs'), (GoTo optionarg')])
    , tokNext "show\\b|sho\\b|sh\\b|unset\\b|unse\\b|uns\\b" (Arbitrary "Keyword") (DoAll [(GoTo noargs'), (GoTo optionarg')])
    , tokNext "lower\\b|lowe\\b|low\\b|raise\\b|rais\\b|rai\\b|ra\\b|call\\b|cal\\b|ca\\b|cd\\b|clear\\b|clea\\b|cle\\b|cl\\b|help\\b|hel\\b|he\\b|h\\b|\\?\\b|history\\b|histor\\b|histo\\b|hist\\b|his\\b|hi\\b|load\\b|loa\\b|lo\\b|l\\b|print\\b|prin\\b|pri\\b|pr\\b|pwd\\b|reread\\b|rerea\\b|rere\\b|rer\\b|re\\b|reset\\b|rese\\b|res\\b|screendump\\b|screendum\\b|screendu\\b|screend\\b|screen\\b|scree\\b|scre\\b|scr\\b|shell\\b|shel\\b|she\\b|system\\b|syste\\b|syst\\b|sys\\b|sy\\b|update\\b|updat\\b|upda\\b|upd\\b|up\\b" (Arbitrary "Keyword") (GoTo genericargs')
    , tokNext "pwd\\b|reread\\b|rerea\\b|rere\\b|rer\\b|re\\b|reset\\b|rese\\b|res\\b|screendump\\b|screendum\\b|screendu\\b|screend\\b|screen\\b|scree\\b|scre\\b|scr\\b|shell\\b|shel\\b|she\\b|test\\b" (Arbitrary "Keyword") (GoTo noargs')
    , tokNext "([a-zA-Z_][a-zA-Z0-9_]*)(\\s*)(=)" (ByGroups [(Arbitrary "Name" :. Arbitrary "Variable"), (Arbitrary "Text"), (Arbitrary "Operator")]) (GoTo genericargs')
    , tokNext "([a-zA-Z_][a-zA-Z0-9_]*)(\\s*\\(.*?\\)\\s*)(=)" (ByGroups [(Arbitrary "Name" :. Arbitrary "Function"), (Arbitrary "Text"), (Arbitrary "Operator")]) (GoTo genericargs')
    , tok "@[a-zA-Z_][a-zA-Z0-9_]*" (Arbitrary "Name" :. Arbitrary "Constant")
